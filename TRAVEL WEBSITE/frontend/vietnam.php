    ...
    <div class="container-fluid page-header">
        <div class="container">
            <div class="d-flex flex-column align-items-center justify-content-center" style="min-height: 400px">
                <h3 style="color:#f7c1c6 ;"  class="display-4 text-uppercase">Viet Nam</h3>
                <div class="d-inline-flex text-white">
                    ...
                    <p style="color: #fff;" class="m-0 text-uppercase">Destination</p>
                </div>
            </div>
        </div>
    </div>
    ...
    <div class="container-fluid py-5">
        <div class="container pt-3 pb-3 mt-2 mb-2">
            <div class="text-center mb-3 pb-3">
                ...
                <h1>Discover Top Destinations in Viet Nam</h1>
            </div>
            <div class="row">
                <div class="container1 pt-2 pb-3">
                    <div class="card__container1">
                       <article class="card__article1">
                          <img src="img/benthanh.jpg" alt="image" class="img-fluid5">
                       ...
                       <article class="card__article1">
                          <img src="img/thuaThienHue.jpg" alt="image" class="img-fluid5">
            
                          <div class="card__data1">
                             <h4 class="m-0 "><i class="fa fa-map-marker-alt text-primary mt-2"></i>Thua Thien Hue</h4>
                             <a href="#" class="card__button1">Read More</a>
                          </div>
                       </article>
            
                       <article class="card__article1">
                          <img src="img/namDinh.jpg" alt="image" class="img-fluid5">
            
                          <div class="card__data1">
                            <h4 class="m-0 "><i class="fa fa-map-marker-alt text-primary mt-2"></i>Nam Dinh</h4>
                             <a href="#" class="card__button1">Read More</a>
                          </div>
                       </article>
            
                       <article class="card__article1">
                        <img src="img/hoiAn.jpg" alt="image" class="img-fluid5">
            
                        <div class="card__data1">
                            <h4 class="m-0 "><i class="fa fa-map-marker-alt text-primary mt-2"></i>Hoi An</h4>
                           <a href="#" class="card__button1">Read More</a>
                        </div>
                     </article>
            
                     <article class="card__article1">
                        <img src="img/sapa.jpg" alt="image" class="img-fluid5">
            
                        <div class="card__data1">
                            <h4 class="m-0 "><i class="fa fa-map-marker-alt text-primary mt-2"></i>Sa Pa</h4>
                           <a href="#" class="card__button1">Read More</a>
                        </div>
                     </article>
            
                     <article class="card__article1">
                        <img src="img/dalat.jpg" alt="image" class="img-fluid5">
            
                        <div class="card__data1">
                            <h4 class="m-0 "><i class="fa fa-map-marker-alt text-primary mt-2"></i>Da Lat</h4>
                           <a href="#" class="card__button1">Read More</a>
                        </div>
                     </article>
                     ...
                     <?php
                        ...
                        while ($destination = mysqli_fetch_assoc($query)) {?>
                            <article class="card__article1">
                                <img src="img/<?php echo $destination['vnImage'];?>" alt="image" class="img-fluid5">
                    
                                <div class="card__data1">
                                    <h4 class="m-0 "><i class="fa fa-map-marker-alt text-primary mt-2"></i><?php echo $destination['vnName'];?></h4>
                                    <a href="#" class="card__button1">Read More</a>
                                </div>
                            </article>
                     <?php }?>
