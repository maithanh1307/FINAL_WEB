...
<?php
    ...
    $sql = "SELECT *, CURDATE() AS datePost from addinformation";
            ...
            <li class="nav-item">
                ...
                <div id="collapseTwo" class="collapse" aria-labelledby="headingTwo" data-parent="#accordionSidebar">
                    <div class="bg-white py-2 collapse-inner rounded">
                        ...
                        <a class="collapse-item" href="buttons.php">List of top destination</a>
        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <!-- Page Heading -->
                    <h1 class="h3 mb-4 text-gray-800">List of top destination</h1>
                        ...
                        <div class="admin-main-content-topdestination-list">
                            <table>
                                <thead>
                                    <tr>
                                        <th>ID</th>
                                        <th>Image of top destination</th>
                                        <th>Name of top destination</th>
                                        <th>Interest</th>
                                        <th>Date Post</th>
                                        <th>Adjust</th>
                                    </tr>
                            ...
                            <a class="btn btn-primary mt-3" href="../frontend/index.php">User interface</a>
                        </div>
                    </div>
