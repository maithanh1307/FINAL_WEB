...
<?php
    ...
    if(isset($_POST['sbm'])) {
        ...
        $hotelImage_tmp = $_FILES['hotelImage']['tmp_name'];
        ...
        //echo "Test3<br>";
        $sql = "INSERT INTO addhotel (hotelName, hotelType, hotelImage, hotelGuest, hotelDescription, hotelPrice) 
        VALUES ('$hotelName', '$hotelType', '$hotelImage', '$hotelGuest', '$hotelDescription', '$hotelPrice')"; //thay sua them thuoc tính date
                ...
                <div class="container-fluid">
                    <form method="POST" enctype="multipart/form-data">
                        ...
                        <div class="d-sm-flex align-items-center justify-content-between mb-4">
                            <h1 class="h3 mb-0 text-gray-800">Add rooms</h1>
                        </div>
                            ...
                            <div class="admin-main-content-topdestination-add">
                                <div class="admin-main-content-left">
                                    <div class="admin-main-content-two-input">
                                        <input name="hotelName" type="text" placeholder="Room Name" required>
                                        <input name="hotelType" type="text" placeholder="Type" required>
                                        <input name="hotelDescription" type="text" placeholder="Description" required>
                                        <input name="hotelGuest" type="text" placeholder="Guest" required>
                                        <input name="hotelPrice" type="text" placeholder="Price" required>
                                    </div>
                                    <div class="admin-main-content-right-image">
                                        <label for="file">Image of room</label>
                                        <input name="hotelImage" id="file" type="file">
