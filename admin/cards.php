...
<?php
    ...
    if(isset($_POST['sbm'])) {
        ...
        VALUES ('$destinationName', '$voteLike', '$destinationImage', '$date')"; //thay sua them thuoc tính date
        ...
        <ul class="navbar-nav ml-auto">
            ...
            <li class="nav-item dropdown no-arrow">
                <a class="nav-link dropdown-toggle" href="#" id="userDropdown" role="button"
                    data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                    <span class="mr-2 d-none d-lg-inline text-gray-600 small">Reis Adventures</span>
                    <img class="img-profile rounded-circle"
                        src="img/icon admin.jpg">
                </a>
                ...
                <div class="dropdown-menu dropdown-menu-right shadow animated--grow-in"
                    ...
                    <a class="dropdown-item" href="signin.php" data-toggle="modal" data-target="#logoutModal">
                ...
                <div class="container-fluid">
                    <form method="POST" enctype="multipart/form-data">
                        ...
                        <div class="d-sm-flex align-items-center justify-content-between mb-4">
                            <h1 class="h3 mb-0 text-gray-800">Add top destination</h1>
                        </div>
                            ...
                            <div class="admin-main-content-topdestination-add">
                                <div class="admin-main-content-left">
                                    <div class="admin-main-content-two-input">
                                        <input name="destinationName" type="text" placeholder="Name of destination" required>
                                        <input name="voteLike" type="text" placeholder="Interest" required>
                                    </div>
                                    <div class="admin-main-content-right-image">
                                        ...
                                        <button name="sbm" class="btn btn-primary" type="submit">Add top destination</button>
