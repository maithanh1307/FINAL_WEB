    ...
    <div class="container-fluid page-header">
        <div class="container">
            <div class="d-flex flex-column align-items-center justify-content-center" style="min-height: 400px">
                <h3 style="color:#f7c1c6 ;"  class="display-4 text-uppercase">Blog</h3>
                <div class="d-inline-flex text-white">
                    <p class="m-0 text-uppercase"><a style="color:#f7c1c6 ;"  href="index.php">Home</a></p>
                    <i style="color:#f7c1c6;" class="fa fa-angle-double-right pt-1 px-3"></i>
                    <p style="color: #fff;"  class="m-0 text-uppercase">Blog</p>
                </div>
            </div>
        </div>
    </div>
        ...
        <div class="container py-5">
            <div class="row">
                <div class="col-lg-8">
                    <div class="row pb-3">
                        <div class="col-md-6 mb-4 pb-2">
                            <div class="blog-item">
                                <div class="position-relative">
                                    <img class="img-fluid1 w-100" src="img/thailand.jpg" alt="">
                                    <div class="blog-date">
                                ...
                                <div class="bg-white p-4">
                                    <div class="d-flex mb-2">
                                        <p class="text-primary text-uppercase text-decoration-none">Espen Egeland</p>
                                        <span class="text-primary px-2">|</span>
                                        <a class="text-primary text-uppercase text-decoration-none" href="">Tours & Travel</a>
                                    </div>
                                    <a class="h5 m-0 text-decoration-none" href="https://nerdnomads.com/where-to-stay-in-phuket">Where To Stay In Phuket, Thailand </a>
                                </div>
                            </div>
                        </div>
                        <div class="col-md-6 mb-4 pb-2">
                            <div class="blog-item">
                                <div class="position-relative">
                                    <img class="img-fluid1 w-100" src="img/muine.jpg" alt="">
                                    <div class="blog-date">
                                ...
                                <div class="bg-white p-4">
                                    <div class="d-flex mb-2">
                                        <p class="text-primary text-uppercase text-decoration-none" href="">Maria Wulff</p>
                                        <span class="text-primary px-2">|</span>
                                        <a class="text-primary text-uppercase text-decoration-none" href="">Tours & Travel</a>
                                    </div>
                                    <a class="h5 m-0 text-decoration-none" href="https://nerdnomads.com/white-sands-mui-ne-vietnam">Kite Surfing at White Sands, Vietnam</a>
                                </div>
                            </div>
                        </div>
                        <div class="col-md-6 mb-4 pb-2">
                            <div class="blog-item">
                                <div class="position-relative">
                                    <img class="img-fluid1 w-100" src="img/singapore_blog.jpg" alt="">
                                    <div class="blog-date">
                                ...
                                <div class="bg-white p-4">
                                    <div class="d-flex mb-2">
                                        <p class="text-primary text-uppercase text-decoration-none">Maria Wulff</p>
                                        <span class="text-primary px-2">|</span>
                                        <a class="text-primary text-uppercase text-decoration-none" href="">Tours & Travel</a>
                                    </div>
                                    <a class="h5 m-0 text-decoration-none" href="https://nerdnomads.com/singapore-itinerary">What To Do In Singapore - A 3 Day Singapore Itinerary</a>
                                </div>
                            </div>
                        </div>
                        <div class="col-md-6 mb-4 pb-2">
                            <div class="blog-item">
                                <div class="position-relative">
                                    <img class="img-fluid1 w-100" src="img/Shwedagon1.jpg" alt="">
                                    <div class="blog-date">
                                ...
                                <div class="bg-white p-4">
                                    <div class="d-flex mb-2">
                                        <p class="text-primary text-uppercase text-decoration-none">Slider, Yangon</p>
                                        <span class="text-primary px-2">|</span>
                                        <a class="text-primary text-uppercase text-decoration-none" href="">Tours & Travel</a>
                                    </div>
                                    <a class="h5 m-0 text-decoration-none" href="https://myanmartravelblog.com/shwedagon-pagoda/">Shwedagon: A Pagoda Like No Other</a>
                                </div>
                            </div>
                        </div>
                        <div class="col-md-6 mb-4 pb-2">
                            <div class="blog-item">
                                ...
                                <div class="bg-white p-4">
                                    ...
                                    <a class="h5 m-0 text-decoration-none" href="https://www.saltinourhair.com/laos/laos-travel-guide/">Laos Travel Guide: Complete 10-Day Itinerary</a>
                                </div>
                            </div>
                        </div>
                        <div class="col-md-6 mb-4 pb-2">
                            <div class="blog-item">
                                <div class="position-relative">
                                    <img class="img-fluid1 w-100" src="img/Luangprabang.jpg" alt="">
                                    <div class="blog-date">
                                ...
                                <div class="bg-white p-4">
                                    <div class="d-flex mb-2">
                                        <p class="text-primary text-uppercase text-decoration-none">Chole</p>
                                        <span class="text-primary px-2">|</span>
                                        <a class="text-primary text-uppercase text-decoration-none" href="">Tours & Travel</a>
                                    </div>
                                    <a class="h5 m-0 text-decoration-none" href="https://www.saltinourhair.com/laos/laos-travel-guide/">Laos Travel Guide: Complete 10-Day Itinerary</a>
                        ...
                        <div class="col-md-6 mb-4 pb-2">
                            <div class="blog-item">
                                <div class="position-relative">
                                    <img class="img-fluid1 w-100" src="img/phnomPenh_blog.jpg" alt="">
                                    <div class="blog-date">
                                ...
                                <div class="bg-white p-4">
                                    <div class="d-flex mb-2">
                                        <p class="text-primary text-uppercase text-decoration-none" href="">Bmeitiner</p>
                                        <span class="text-primary px-2">|</span>
                                        <a class="text-primary text-uppercase text-decoration-none" href="">Tours & Travel</a>
                                    </div>
                                    <a class="h5 m-0 text-decoration-none" href="https://bea-adventurous.com/5-days-in-cambodia/">How to Spend 5 Days in Cambodia</a>
                                </div>
                            </div>
                        </div>
                        <div class="col-md-6 mb-4 pb-2">
                            <div class="blog-item">
                                <div class="position-relative">
                                    <img class="img-fluid1 w-100" src="img/Borobudur.jpg" alt="">
                                    <div class="blog-date">
                                        <h6 class="font-weight-bold mb-n1">05</h6>
                                ...
                                <div class="bg-white p-4">
                                    <div class="d-flex mb-2">
                                        <p class="text-primary text-uppercase text-decoration-none">Hauglann</p>
                                        <span class="text-primary px-2">|</span>
                                        <a class="text-primary text-uppercase text-decoration-none" href="">Tours & Travel</a>
                                    </div>
                                    <a class="h5 m-0 text-decoration-none" href="https://nerdnomads.com/borobudur">From Dawn Till Dusk At Borobudur Temple</a>
                                </div>
                            </div>
                        </div>
                        <div class="col-md-6 mb-4 pb-2">
                            <div class="blog-item">
                                <div class="position-relative">
                                    <img class="img-fluid1 w-100" src="img/kl.jpg" alt="">
                                    <div class="blog-date">
                                        <h6 class="font-weight-bold mb-n1">30</h6>
                                        <small class="text-white text-uppercase">May</small>
                                    </div>
                                </div>
                                <div class="bg-white p-4">
                                    ...
                                    <a class="h5 m-0 text-decoration-none" href="">Must Try Restaurants In KL – Kuala Lumpur</a>
                                </div>
                            </div>
                        </div>
                        <div class="col-12">
                            <nav aria-label="Page navigation">
                                <ul class="pagination pagination-lg justify-content-center bg-white mb-0" style="padding: 30px; border-radius: 15px;">
                ...
                <div class="col-lg-4 mt-5 mt-lg-0">
                    <!-- Author Bio -->
                    <div style="border-radius:20px ;" class="d-flex flex-column text-center bg-white mb-5 py-5 px-4">
                        <img src="img/testimonial-4.jpg" class="feed-back img-fluid mx-auto mb-3" style="width: 100px; height: 100px;">
                        <h3 class="text-primary mb-3">Matthew Liu</h3>
                        <p style="color:#000">
                            Meet Matthew Liu, an avid traveler and lifestyle blogger who shares her adventures, tips, and insights on discovering the world's hidden gems
                        </p>
                        <div class="d-flex justify-content-center">
                            <a class="text-primary px-2" href="https://www.instagram.com/johnnnyhuynh/">
                                <i class="fab fa-facebook-f"></i>
                            </a>
                            <a class="text-primary px-2" href="https://www.instagram.com/johnnnyhuynh/">
                                <i class="fab fa-twitter"></i>
                    ...
                    <div class="mb-5">
                        ...
                        <a class="d-flex align-items-center text-decoration-none bg-white mb-3" href="https://www.saltinourhair.com/tips/reduce-plastic-travel/">
                            <img class="img-fluid" src="img/blog_grid4.jpg" alt="">
                            <div class="pl-3">
                                <h6 class="m-1">13 Easy Tips to Reduce Plastic</h6>
                                <small>Jan 26, 2024</small>
                            </div>
                        </a>
                        <a class="d-flex align-items-center text-decoration-none bg-white mb-3" href="https://www.saltinourhair.com/tips/sustainable-travel/">
                            <img class="img-fluid" src="img/blog_grid5.jpg" alt="">
                            <div class="pl-3">
                                <h6 class="m-1">10 Easy Tips for You to Use Now</h6>
                                <small>Mar 07, 2024</small>
                            </div>
                        </a>
                        <a class="d-flex align-items-center text-decoration-none bg-white mb-3" href="https://www.saltinourhair.com/japan/things-to-do-nara/">
                            <img class="img-fluid" src="img/blog_grid6.jpg" alt="">
                            <div class="pl-3">
                                <h6 class="m-1">9 Things to do in Nara Park</h6>
