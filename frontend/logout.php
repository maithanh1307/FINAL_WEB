    ...
    <div class="container">
      <div class="row">
        <div class="col-md-6 mt-5 mx-auto p-3 border rounded">
            ...
            <p>Click <a href="../frontend/signin.php">here</a> to return to the login page, or the website will automatically redirect in  <span id="counter" class="text-danger">10</span> second.</p>
