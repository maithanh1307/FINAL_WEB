...
<body>
    ...
    <div class="container-fluid page-headerMM">
        ...
        <div class="container">
            <div class="d-flex flex-column align-items-center justify-content-center" style="min-height: 400px">
                <h3 style="color:#f7c1c6 ;"  class="display-4 text-uppercase">Myanmar</h3>
    ...
    <!-- Destination Start -->
    <div class="container-fluid py-5 page-headerMyanmar">
        <div class="container pt-3 pb-3 mt-2 mb-2">
            <div class="text-center mb-3 pb-3">
                <h6 class="text-primary text-uppercase" style="letter-spacing: 5px;">Destination</h6>
                <h1>Discover Top Destinations in Myanmar</h1>
            </div>
            <div class="row">
                <div class="container1 pt-2 pb-3">
                    <div class="card__container1">
                       <article class="card__article1">
                          <img src="img/Shwedagon1.jpg" alt="image" class="img-fluid5">
            
                          <div class="card__data1">
                            <h4 class="m-0 "><i class="fa fa-map-marker-alt text-primary mt-2"></i>Shwedagon</h4>
                            <a href="myanmar_blog.html" class="card__button1">Read More</a>
                          </div>
                       </article>
            
                       <article class="card__article1">
                          <img src="img/inle1.jpg" alt="image" class="img-fluid5">
            
                          <div class="card__data1">
                             <h4 class="m-0 "><i class="fa fa-map-marker-alt text-primary mt-2"></i>Inle</h4>
                             <a href="#" class="card__button1">Read More</a>
                          </div>
                       </article>
            
                       <article class="card__article1">
                          <img src="img/bagan1.jpg" alt="image" class="img-fluid5">
            
                          <div class="card__data1">
                            <h4 class="m-0 "><i class="fa fa-map-marker-alt text-primary mt-2"></i>Bagan</h4>
                             <a href="#" class="card__button1">Read More</a>
                          </div>
                       </article>
            
                       <article class="card__article1">
                        <img src="img/kyaikhtiyo1.jpg" alt="image" class="img-fluid5">
            
                        <div class="card__data1">
                            <h4 class="m-0 "><i class="fa fa-map-marker-alt text-primary mt-2"></i>Kyaikhtiyo</h4>
                           <a href="#" class="card__button1">Read More</a>
                        </div>
                     </article>
            
                     <article class="card__article1">
                        <img src="img/sule1.jpg" alt="image" class="img-fluid5">
            
                        <div class="card__data1">
                            <h4 class="m-0 "><i class="fa fa-map-marker-alt text-primary mt-2"></i>Sule</h4>
                           <a href="#" class="card__button1">Read More</a>
                        </div>
                     </article>
            
                     <article class="card__article1">
                        <img src="img/u_bein1.jpg" alt="image" class="img-fluid5">
            
                        <div class="card__data1">
                            <h4 class="m-0 "><i class="fa fa-map-marker-alt text-primary mt-2"></i>U Bein</h4>
                           <a href="#" class="card__button1">Read More</a>
                        </div>
                     </article>
