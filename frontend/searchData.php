                                    ...
                                    <div class="row col-lg-4 col-md-7 col-sm-12 ml-auto mr-auto">
                                        ...
                                        <div class="row">
                                            <div class="row ml-0 pb-2 mr-2 ml-4 mr-2 benthanh_detail" style="width: 100px; height: 30px;">
                                                <i class="fas fa-utensils fa-sm" style="color: #ff0066;"></i><i class=" icontree fad fa-tree-palm fa-sm ml-3" style="--fa-primary-color: #ff0066; --fa-secondary-color: #ff0066; transform:translateY(-15px);"></i>
                                            </div>
